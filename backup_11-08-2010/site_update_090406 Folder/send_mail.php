	...
	if ($subj != "" && $subj != " ")
		{
			...
			if (isset($_REQUEST['form']) && ($_REQUEST['form'] == "career_form"))
				{
					$whoto .= ",Tnoto@GibsonPlumbing.Com";
					$headers = "From: Employment_Request_form@gibsonplumbing.com.com\r\n";
				}
			else
				{
/**/
					$whoto .= ",Shernandez@GibsonPlumbing.com,Ktschoepe@GibsonPlumbing.com,Mrodriguez@GibsonPlumbing.com";
