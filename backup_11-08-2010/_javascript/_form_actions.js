...
*/
			...
			if (site == "admin")

				{
					...
					//window.location="../send_mail.php?" + string_value+"gotoURL="+gotoURL+"&form="+frm.name;
...

				{
					...
					send_loc = (gotoURL+"?"+string_value+"gotoURL="+gotoURL+"&form="+frm.name);

					//alert(send_loc);

					//alert("send_mail.php?"+string_value+"gotoURL="+gotoURL+"&form="+frm.name);

					//window.location="send_mail.php?"+string_value+"gotoURL="+gotoURL+"&form="+frm.name;

					window.location=send_loc;
